...
After the signed release, #251 -> #253 -> modules #433; core #684 -> modules
Issue #434 remains a later branch; modules C15 #417 -> core C15 #679 remains the
signal-calibration branch. Existing policy/exception blockers remain in force.
