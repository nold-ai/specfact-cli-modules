...
- [ ] Verify the #459 layout correction and released core #679; retain relevant C15 prerequisites and exact release/install evidence without waiting for optional #434.
- [ ] Reassess this change with the released layout/C15 baseline and refine the candidate design; complete the following dependency and platform audits before approval.
...
- [ ] Implement portable orchestration, native provisioning/backends, and required consumer changes within approved scope; use focused current-run verification during work.
...
- [ ] Summarize relevant regression failures and current passing results, run quality/review gates, and verify native release/signature/registry compatibility. Use seals/checkpoint/conformance records only under explicitly selected optional policy.
