...
This change implements proposal scope for `sync-01-unified-kernel` from the 2026-02-15 architecture-layer integration plan. It is proposal-stage only and defines implementation strategy without changing runtime code.
...
- Dependency summary: Depends on patch-mode-01-preview-apply.
