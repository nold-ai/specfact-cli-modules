...
- [ ] 1.1 Create dedicated worktree branch `feature/requirements-02-module-commands` from `dev` before implementation work: `scripts/worktree.sh create feature/requirements-02-module-commands`.
...
- [ ] 4.3 Run `openspec validate requirements-02-module-commands --strict` and resolve all issues.
