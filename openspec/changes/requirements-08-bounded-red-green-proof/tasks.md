...
- [ ] 1.2 Add `test_final_reconciliation_keeps_current_execution_and_red_green_chronology_separate` and `test_report_schema_v4_discriminates_r08_from_r07_v3_and_legacy_v2`; assert mapping sidecars stay v2, finalized v2 is legacy-only, finalized v3 is R07 compatibility, v4 requires request plus both claims, missing v4 fields do not downgrade, and unsupported future versions are rejected.
