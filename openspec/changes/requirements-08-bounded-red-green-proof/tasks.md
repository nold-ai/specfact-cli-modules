...
- [ ] 2.4 Require and retain the schema-v4 chronology claim object in Code Review context without requiring a successful chronology attestation and without verdict fusion; route finalized report v2 through legacy compatibility and v3 through R07 compatibility, always retaining the source version.
