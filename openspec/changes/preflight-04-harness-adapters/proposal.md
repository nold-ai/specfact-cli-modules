...
- Future implementation consumes the exact signed #434 module identity plus the separately named preflight workflow identity/digest and implementation-check workflow identity/digest, core #251 installation/export behavior, and core #253 generated instruction contract.
