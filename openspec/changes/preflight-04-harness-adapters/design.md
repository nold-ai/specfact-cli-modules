...
Every adapter consumes a descriptor containing the exact signed SpecFact module identity, canonical workflow identity/digest, supported harness and version range, native invocation form, asset mapping, instruction markers, install scope, and uninstall inventory. Unsupported or mismatched identities fail closed with a diagnostic.
