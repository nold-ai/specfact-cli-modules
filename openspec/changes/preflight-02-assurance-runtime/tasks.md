...
- [ ] 2.2 Add tests mapped to every runtime and workflow scenario, including invalid path roles, missing component targets, uncovered/not-applicable risk rows, planned cases without selectors, planned-to-test-authored selector reconciliation, successor-seal lineage preservation, stale Requirements plans, read-only defaults, unknown fail-closed behavior, approval invalidation, and renderer parity.
