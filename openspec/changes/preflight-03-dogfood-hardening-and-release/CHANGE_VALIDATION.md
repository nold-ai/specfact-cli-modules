...
- Review follow-up on 2026-08-27: strict OpenSpec validation and staged schema-v2 Requirements planning evidence PASS after the archival, workflow-delta, compatibility, and rollback corrections; the diff remains planning-only.
