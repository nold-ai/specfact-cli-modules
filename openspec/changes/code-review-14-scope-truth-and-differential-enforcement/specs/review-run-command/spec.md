...
- **THEN** a blocking analyzer finding or valid collected assertion/skip/xfail/xpass outcome records `execution_state=ran`, `evidence_outcome=FAIL`, and aggregate FAIL
