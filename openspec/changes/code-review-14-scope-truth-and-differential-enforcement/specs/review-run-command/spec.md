...
- **THEN** comment-token manifests are compared before analyzer fingerprints under the signed `suppression-directives-v1` registry, including Pylint `disable-all` and legacy `disable-msg=<rule-list>` aliases
