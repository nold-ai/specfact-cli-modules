...
- **AND** missing, invalid, in-checkout, self-asserted, or consumer-unverified context emits `range_preview` or UNKNOWN and cannot satisfy `pr_range`.
