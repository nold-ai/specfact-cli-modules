...
- Publish a signed schema 1.6 consumer compatibility matrix covering all authoritative statuses, the mixed FAIL/UNKNOWN precedence case, legacy projections, exit behavior, and accepted/rejected envelope fixtures before any core consumer migration. The matrix is a static interoperability resource, not a module-side workflow verifier.
