...
- `--scope range --base-ref <full-ref> --head-ref <full-ref> [--pr-context-file <absolute-path>]`: committed merge-base-to-head delta; protected authenticated context yields `pr_range`, absence/unverified context yields `range_preview`;
