...
- [ ] 5.4 Allow only the canonical post-merge publication workflow to generate, sign, verify, compatibility-test, and propose the immutable #434 module, registry, checksum, signature, and history artifacts; review and merge that publication PR only after every identity and rollback check passes.
