...
The implementation MUST apply ignore policies in the following explicit order:

1. First, load the deterministic default ignore policy
2. Then, read and merge `.specfact/.specfactignore` patterns
3. Finally, apply explicit user target paths (which override ignored paths)
