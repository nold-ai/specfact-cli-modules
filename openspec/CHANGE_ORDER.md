...
| 6 | `requirements-07-scenario-runtime-proof` | [#368](https://github.com/nold-ai/specfact-cli-modules/issues/368) | Emit safe scenario test plans, reconcile JUnit proof, and provide read-only Requirements context to Code Review | requirements-06; paired core [#662](https://github.com/nold-ai/specfact-cli/issues/662) consumes the release |
