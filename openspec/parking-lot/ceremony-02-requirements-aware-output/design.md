...
This change implements proposal scope for `ceremony-02-requirements-aware-output` from the 2026-02-15 architecture-layer integration plan. It is proposal-stage only and defines implementation strategy without changing runtime code.
...
- Dependency summary: Depends on requirements-02-module-commands and ceremony-cockpit-01-ceremony-aliases.
