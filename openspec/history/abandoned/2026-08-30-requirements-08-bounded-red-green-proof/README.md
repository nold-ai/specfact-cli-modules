...
> **Abandoned planning history without specification promotion — superseded and never
> implemented.** Modules issue #414 and paired core issue #675 were closed as
> `not planned` on 2026-08-27. On 2026-08-30, an explicit repository-owner
> decision retained this complete folder under non-canonical abandoned history
> without running `openspec archive`; therefore none of its delta specifications
> were merged into canonical requirements. The lower-cost seal-bound checkpoint
