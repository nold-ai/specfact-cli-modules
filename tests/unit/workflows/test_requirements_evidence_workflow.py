...
def test_requirements_evidence_workflow_skips_circular_core_dependency_on_main_promotion() -> None:
    job = _workflow_job()
    ...
    assert "Enforce paired core requirements command parity" not in steps
