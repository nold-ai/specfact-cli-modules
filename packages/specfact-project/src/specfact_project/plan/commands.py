    ...
    **Examples:**
    ...
    with telemetry.track_command("plan.update_idea", telemetry_metadata) as record:
        ...
        try:
            ...
            if idea is None:
                print_error("Failed to initialize idea section")
                raise typer.Exit(1)
        ...
        try:
            ...
            if sdd_path.exists():
                try:
                    ...
                    if existing_sdd is not None and existing_sdd.plan_bundle_hash == project_hash:
