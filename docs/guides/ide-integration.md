...
|---------|-------------|----------------|
| `/specfact.01-import` | Import codebase into project bundle | `specfact code import <bundle-name>` |
...
| `/specfact.03-review` | Review plan and select active bundle | `specfact plan compare --bundle <bundle-name>`, `specfact plan select` |
| `/specfact.04-sdd` | Create SDD manifest from plan | `specfact enforce sdd --bundle <bundle-name>` |
