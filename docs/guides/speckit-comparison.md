...
specfact project sync bridge --adapter speckit --repo ./my-project --mode change-proposal --feature 001-auth-sync

# Step 3: Bulk-convert every untracked Spec-Kit feature into OpenSpec changes
specfact project sync bridge --adapter speckit --repo ./my-project --mode change-proposal --all
