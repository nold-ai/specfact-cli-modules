...
|------|------------------|-------------------|
| **Work with existing code** ⭐ **PRIMARY** | ⚠️ **Not designed for** - Focuses on spec authoring | ✅ **`code import`** ⭐ - Reverse-engineer existing code to plans (PRIMARY use case) |
...
specfact code import --repo ./legacy-app legacy-api
