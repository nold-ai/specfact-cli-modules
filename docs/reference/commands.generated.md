...
| `specfact requirements evidence` | nold-ai/specfact-requirements | `specfact module install nold-ai/specfact-requirements` | --base-ref, --output, --plan-output, --policy, --repo-root, --required-maturity, --review-evidence, --staged, --summary; args: - | - |  |
